//********************************************************************
//	filename: 	F:\mygit\QtResArscEditor2\src\common\utf8.h
//	desc:		
//
//	created:	https://github.com/haipome/utf8/tree/master
//********************************************************************
#ifndef utf8_h__
#define utf8_h__
/*
 ...
 */
size_t u8decode(char const* str, ucs4_t* des, size_t n, size_t* illegal);

/*
* 计算需要多少字节空间来存放
*/
size_t u8decodelen(char const* str);
/*
 ...
 */
size_t u8encode(ucs4_t* us, char* des, size_t n, size_t* illegal);
/*
* 计算需要多少字节空间来存放
*/
